          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.todayStyle}>
              <View style={styles.pieBox}>
                <Progress.Pie progress={this.props.profile.dailyGoals[5]} color="#33FF11" size={150}/>
              </View>
              <View style={styles.todayTextBox}>
                <Text style={styles.todayText1}> Distance Goal: 5 Km</Text>
                <Text style={styles.todayText1}> Progress: {this.props.profile.dailyDistances[5]} Km</Text>
              </View>
            </View>
          </View>
